...
namespace TYFramework.Core.Singleton
{
    ...
    internal static class SingletonCreator
    {
        ...
        static T CreateNonPublicConstructorObject<T>() where T : class
        {
            ...
            if (ctor == null)
            {
                throw new Exception($"在{type}中，没有找到非public构造函数!");
            }
        ...
        public static T CreateSingleton<T>() where T : class, ISingleton
        {
            ...
            if (monoBehaviourType.IsAssignableFrom(typeof(T)))
            {
                return CreateMonoSingleton<T>();
            }

            //由于单例特性，不公开构造函数，所以这里是CreateNonPublicConstructorObject => NonPublic
        ...
        public static T CreateMonoSingleton<T>() where T : class, ISingleton
        {
            ...
            {
                if (attribute is MonoSingletonPath defineAttr)
                {
